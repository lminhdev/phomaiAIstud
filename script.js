...
async function processFile(
    ...
    if (!text) {
        ...
        showToast(
            "File không có nội dung văn bản."
        );
...
Đã tạo ${document.chunks.length} chunks.
...
const toolPrompts = {
    ...
    explain:
        "Hãy giải thích kiến thức quan trọng trong tài liệu thật dễ hiểu.",
